...
function ProductDetail() {
    ...
    useLayoutEffect(() => {
        if (
            ...
            dispatch(
                getRelatedProduct(
                    singleProduct?.productCategories[0].category.id
                )
            );
        }
    }, [singleProduct]);
    ...
    const handleAddToCart = () => {
        ...
        dispatch(addProduct(product_add));
        dispatch(
            setAlert({ type: t("success"), content: t("notify_add_cart") })
        );
    };
                    ...
                    <div className="sm:w-5/6 w-full mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7 gap-2  py-10">
                            <div className="xl:col-span-4">
                                <Slideshow
                                    images={singleProduct?.productImages}
                                />
                            </div>
                            <div className="xl:col-span-3 md:col-span-2 md:px-2">
                                ...
                                <div className="product-color py-1">
                                    ...
                                    <div className="grid grid-cols-3 xl:grid-cols-6 lg:grid-cols-7 md:grid-cols-6 gap-2">
                                        {singleProduct?.productColors?.map(
                                            (color, index) => {
                                                if (
                                                    !selectedColor &&
                                                    index == 0
                        ...
                        {Object.keys(user).length > 0 && (
                            <div className="review">
                                <h1 className="text-4xl my-5 py-3">
                                    {" "}
                                    {t("review")}
                                </h1>
                                <div className="flex">
