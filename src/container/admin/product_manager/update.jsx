...
function ProductUpdate() {
    ...
    useLayoutEffect(() => {
        ...
        for (let i = 0; i < manager.colors.length; i++) {
            if (
                manager.colors[i].id ==
                selectedColor[selectedColor.length - 1]?.id
            ) {
                index = i;
            }
        }
            ...
            if (
                ...
                for (let i = 0; i < selectedColor.length; i++) {
                    ...
                    for (let size of selectedColor[i].productSizes) {
                        let selected = selectedSize.filter(
                            (s) => s.id == size.id
                        );
            ...
            <div className="w-10/12 bg-slate-700 text-white h-screen flex flex-col overflow-y-hidden ">
                ...
                <div className="w-full overflow-x-hidden ">
                    <main className="w-full flex-grow p-6">
                        <h1 className="w-full text-3xl pb-6">
                            {t("update_product")}
                        </h1>
